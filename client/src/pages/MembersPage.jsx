...
const MembersPage = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-0">
      ...
      >
        <h1 className="text-xl sm:text-2xl font-semibold text-white mb-1">Members</h1>
      ...
      <motion.div
        ...
        className="bg-gray-900 border border-gray-800 rounded-xl p-4 sm:p-5 mb-6"
      >
        <h2 className="text-white font-medium text-sm mb-4 flex items-center gap-2">
          <UserPlus size={15} className="text-violet-400 flex-shrink-0" />
          Invite a member
        </h2>
        <form onSubmit={handleInvite} className="flex flex-col sm:flex-row gap-2">
          ...
          <div className="flex gap-2">
            <select
              ...
              className="flex-1 sm:flex-none bg-gray-800 border border-gray-700 text-white rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-violet-500 transition"
              style={{ fontSize: "16px" }}
            >
              {ROLE_OPTIONS.map((r) => (
            ...
            <button
              ...
              className="flex-1 sm:flex-none bg-violet-600 hover:bg-violet-500 active:bg-violet-500 disabled:opacity-50 disabled:cursor-not-allowed text-white font-medium px-4 py-2.5 rounded-lg text-sm transition-colors whitespace-nowrap"
            >
            ...
            {members.map((member, i) => {
              ...
              return (
                <motion.li
                  ...
                  className="flex flex-col sm:flex-row sm:items-center justify-between px-4 sm:px-5 py-4 border-b border-gray-800 last:border-0 gap-3 sm:gap-4"
                >
                  {/* Avatar + name */}
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-3 flex-shrink-0 pl-12 sm:pl-0">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                      ...
                      <button
                        ...
                        className="p-2 sm:p-1.5 rounded-md text-gray-600 hover:text-red-400 hover:bg-red-400/10 active:bg-red-400/10 transition-colors disabled:opacity-50"
                      >
                        <Trash2 size={14} />
                      </button>
                    </div>
